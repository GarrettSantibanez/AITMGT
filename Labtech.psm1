...
#>
    ...
    End{
        ...
        If ($GoodServer) {
            ...
            $iarg = "/i ""$env:windir\temp\LabTech\Installer\Agent_Install.msi"" SERVERADDRESS=$GoodServer SERVERPASS=$ServerPassword LOCATION=$LocationID SERVICEPORT=$TrayPort /l ""$logpath\$logfile.log"""
