                    ...
                    Try{
                        ...
                        If ($uninstallerResult.StatusCode -ne 200) {
                            ...
                            If ($PSCmdlet.ShouldProcess("$uninstaller", "DownloadFile")) {
                                ...
                                If ((Test-Path "$($env:windir)\temp\Agent_Uninstall.exe") -and !((Get-Item "$($env:windir)\temp\Agent_Uninstall.exe" -EA 0).length/1KB -gt 305)) {
...
#>
    ...
    End{
        ...
        If ($GoodServer) {
            ...
            $iarg = "/i ""$env:windir\temp\LabTech\Installer\Agent_Install.exe"" SERVERADDRESS=$GoodServer $PasswordArg LOCATION=$LocationID SERVICEPORT=$TrayPort /qn /l ""$logpath\$logfile.log"""
